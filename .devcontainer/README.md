...
```
speakeasy generate usage -s https://raw.githubusercontent.com/speakeasy-sdks/w-ai-openapi/main/openapi.yaml -l python -i {INPUT_OPERATION_ID} -o ./samples
```

- To generate samples for an entire namespace (like a tag or group name), use:

```
speakeasy generate usage -s https://raw.githubusercontent.com/speakeasy-sdks/w-ai-openapi/main/openapi.yaml -l python -n {INPUT_TAG_NAME} -o ./samples
```
