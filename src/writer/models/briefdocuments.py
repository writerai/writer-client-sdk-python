...
import dataclasses
from .briefdocument import BriefDocument
...
class BriefDocuments:
    ...
    result: Optional[List[BriefDocument]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('result'), 'exclude': lambda f: f is None }})
