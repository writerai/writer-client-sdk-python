...
class Terminology:
    ...
    def add_terms(self, request: operations.AddTermsRequest) -> operations.AddTermsResponse:
        r"""Add terms
        """
        
        base_url = self._server_url
        
        url = utils.generate_url(base_url, '/terminology/organization/{organizationId}/team/{teamId}', request.path_params)
    ...
    def delete_terms(self, request: operations.DeleteTermsRequest) -> operations.DeleteTermsResponse:
        r"""Delete terms
        """
    ...
    def find_terms(self, request: operations.FindTermsRequest) -> operations.FindTermsResponse:
        r"""Find terms
        """
    ...
    def update_terms(self, request: operations.UpdateTermsRequest) -> operations.UpdateTermsResponse:
        r"""Update terms
        """
