...
class Styleguide:
    ...
    def get(self, page_id: int) -> models.PageDetailsResponse:
        ...
        res = models.PageDetailsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res, headers=None)
    ...
    def list_pages(self, limit: Optional[int] = None, offset: Optional[int] = None, status: Optional[models.QueryParamStatus] = None) -> models.ListPagesResponse:
        ...
        query_params = { **utils.get_query_params(models.ListPagesRequest, request, self.sdk_configuration.globals), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = models.ListPagesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res, headers=None)
