...
class DownloadTheCustomizedModel:
    ...
    def fetch_customized_model_file(self, request: operations.FetchCustomizedModelFileRequest) -> operations.FetchCustomizedModelFileResponse:
        r"""Download your fine-tuned model (available only for Palmyra Base and Palmyra Large)
        """
        
        base_url = self._server_url
        
        url = utils.generate_url(base_url, '/llm/organization/{organizationId}/model/{modelId}/customization/{customizationId}/fetch', request.path_params)
