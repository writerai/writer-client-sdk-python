...
class CoWrite:
    ...
    def generate_content(self, request: operations.GenerateContentRequest) -> operations.GenerateContentResponse:
        ...
        url = utils.generate_url(base_url, '/cowrite/organization/{organizationId}/team/{teamId}/generate', request.path_params)
    ...
    def get_template_inputs(self, request: operations.GetTemplateInputsRequest) -> operations.GetTemplateInputsResponse:
        r"""Get a list of your existing CoWrite templates
        """
        
        base_url = self._server_url
        
        url = utils.generate_url(base_url, '/cowrite/organization/{organizationId}/team/{teamId}/template/{templateId}', request.path_params)
        ...
        res = operations.GetTemplateInputsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
